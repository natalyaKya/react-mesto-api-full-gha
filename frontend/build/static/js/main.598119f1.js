/*! For license information please see main.598119f1.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, n, t) {
        ...
        function Kn(e, n, t, r) {
          if (Wn) {
            var l = Xn(e, n, t, r);
            if (null === l) Hr(e, n, r, Yn, t), jn(e, r);
            else if (
              (function (e, n, t, r, l) {
                switch (n) {
                  case "focusin":
    ...
    (function () {
      ...
      var p = function (n) {
        var t = e.useContext(d),
          r = n.card.owner._id === t._id,
          l = n.card.likes.some(function (e) {
            return e._id === t._id;
          }),
          a = "card__like-button ".concat(l && "card__like-button_active");
        return (0, o.jsxs)("div", {
          ...
          children: [
            (0, o.jsx)("div", {
              ...
              style: { backgroundImage: "url(".concat(n.link, ")") },
            }),
            (0, o.jsx)("h2", { className: "elements__text", children: n.name }),
            r &&
              (0, o.jsx)("button", {
          ...
          children: [
            ...
            (0, o.jsx)("section", {
              ...
              children: n.cards.map(function (e) {
                return (0,
                o.jsx)(p, { name: e.name, link: e.link, likes: e.likes, onCardClick: n.onCardClick, onCardLike: n.onCardLike, onCardDelete: n.onCardDelete, card: e }, e._id);
              }),
            }),
          ],
        });
      ...
      var h = function () {
        return (0, o.jsx)("footer", {
          ...
          children: (0, o.jsx)("p", {
            ...
            children: "\xa9 2020 Mesto Russia",
          }),
        });
      };
      var v = function (e) {
            ...
            children: [
              ...
              (0, o.jsxs)("form", {
                ...
                children: [
                  ...
                  e.children,
                  (0, o.jsx)("button", {
                    className: "popup__button popup__button-".concat(
                      e.name,
                      " popup__button-load"
                    ),
                    type: "submit",
      ...
      var g = function (e) {
        var n = e.card,
          t = e.onClose;
        return (0, o.jsx)("div", {
          className: "popup popup_type_full-size ".concat(
            n.name ? "popup_opened" : ""
          ),
          children: (0, o.jsxs)("div", {
            className: "popup__container",
            children: [
              ...
              (0, o.jsx)("div", {
                className: "popup__form-full-size",
                name: "popup",
      ...
      var y = function () {
          ...
          return (
            (0, e.useEffect)(function () {
              Promise.all([f.getInitialCards(), f.getUserInfo()])
                .then(function (e) {
                  var n = l(e, 2),
                    t = n[0],
                    r = n[1];
              ...
              children: [
                ...
                (0, o.jsx)(m, {
                  ...
                  onCardLike: function (e) {
                    e.likes.some(function (e) {
                      ...
                      ? f.removeLike(e._id).then(function (n) {
                          N(function (t) {
                      ...
                      : f.addLike(e._id).then(function (n) {
                          N(function (t) {
                            return t.map(function (t) {
                              return t._id === e._id ? n : t;
                            });
                  ...
                  onCardDelete: function (e) {
                    f.deleteCard(e._id).then(function () {
                      N(
                        C.filter(function (n) {
                          return n._id !== e._id;
                        })
                ...
                (0, o.jsxs)(v, {
                  ...
                  children: [
                    ...
                    (0, o.jsx)("span", {
                      className: "name-profile-error popup__text-error",
                    }),
                    (0, o.jsx)("input", {
                      id: "job-profile",
                    ...
                    (0, o.jsx)("span", {
                      className: "job-profile-error popup__text-error",
                    }),
                  ],
                }),
                (0, o.jsxs)(v, {
                  ...
                  children: [
                    ...
                    (0, o.jsx)("span", {
                      className: "place-card-error popup__text-error",
                    }),
                    (0, o.jsx)("input", {
                      id: "link-card",
                    ...
                    (0, o.jsx)("span", {
                      className: "link-card-error popup__text-error",
                    }),
                  ],
                }),
                (0, o.jsx)(v, {
                ...
                (0, o.jsxs)(v, {
                  ...
                  children: [
                    ...
                    (0, o.jsx)("span", {
                      className: "link-avatar-error popup__text-error",
                    }),
                  ],
                }),
                (0, o.jsx)(g, { card: k, onClose: P }),
                (0, o.jsx)(h, {}),
              ],
            })
          );
      ...
      n
        ...
        .render((0, o.jsx)(e.StrictMode, { children: (0, o.jsx)(y, {}) })),
        b();
    })();
})();
//# sourceMappingURL=main.598119f1.js.map
